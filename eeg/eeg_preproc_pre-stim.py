...
for obs_i in obs_all:
	...
	for block_i in range(1, 9):
		...
		if os.path.exists(file_n):
			...
			block_temp = mne.io.read_raw_brainvision(file_n, montage = montage, eog = ('HEOG', 'VEOG'), preload=True, verbose=50)
	...
	raw_all2 = raw_all2.set_eeg_reference('average')
	...
	epochs.save(obs_path + 'eeg/obs%i_allclean_pre-stim_epo.fif.gz' % obs_i, overwrite = True)
