...
sim_path = base_path +\
	'/LFC_compet_sw2_%.2f_kick_%.2f_thresh_%.2f_cgSd_%.2f_sigmaCompet_%.3f_inhCompet_%.2f_alphCompet_%.3f_tilt_%.4f_dampThetaCoef_%.4f_1/'\
	% (sw2, kick_value, MFC_compet_thresh, Cgs_var_sd, sigma_compet, inh_compet, alpha_compet, tiltrate, damp_thetaFreq_coef)
